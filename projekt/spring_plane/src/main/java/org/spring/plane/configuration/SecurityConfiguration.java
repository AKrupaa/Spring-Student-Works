...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/userRole*").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/edit/airplane*").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/delete/airplane*").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/user/edit*").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/user/delete/*").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/user/toggle/*").access("hasRole('ROLE_ADMIN')")
                .antMatchers("/userRole*").access("hasRole('ROLE_ADMIN')")
